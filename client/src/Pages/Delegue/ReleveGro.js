...
function ReleveGro() {
  ...
  const saveTable = useCallback(
    async (entities, uploadFile, fourSelected, annee, mois,type,typeGro,delegueSelected) => {
      ...
      if (verif === false) {
        ...
        if (fourSelected !== null) {
          dispatch(saveFile(dataArray)).then((e) => {
            ...
            if (idRole === 3){
              var id_delegue =  delegueSelected.value;
            }
            else{
              var id_delegue = 0 ;
            }
       dispatch(releveAdded({type:type.value,typeGro:typeGro.value, annee: annee.value, mois: mois.value, file: filename, namefile: uploadFile.name, ligneReleve: entities, four: fourSelected.value ,id_delegue : id_delegue,
       })).then((e) => {
              if (e.payload === true) {
                ...
                <Row className="hidden" id="table-BL">
                  ...
                  <Col md="12">
                    ...
                    <Button
                      ...
                      variant="success"
                      onClick={() =>
                        saveTable(entities, uploadFile, fourSelected, annee, mois,type,typeGro,delegueSelected)
                      }
                    >
                      <span className="btn-label">
