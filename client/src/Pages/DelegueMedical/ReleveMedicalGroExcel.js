...
import {
  ...
  cheeckProduit,
  verifReleve,
} from "../../Redux/releveMedicalReduce";
...
function ReleveMedicalGroExcel() {
  /* const str = "Karray-feěvrier-2023.xlsx";
  console.log(str.replace(/[^a-zA-Z0-9,;\-.!? ]/g, ''),str); */
  var list = [43, 16, 47, 41, 12, 40, 48, 46, 28, 11, 44, 13, 38, 50, 17];
  ...
  const fileHandler = (e, fourSelected, mois, annee, testAffiche, type) => {
  ...
  const getOptionLabel = (option) => {
    ...
    if (list.indexOf(parseInt(option.value)) > -1)
      classNames = "";
  ...
  return (
    <>
      <Container fluid className="responsive-BL table-dynamique releve-class">
        ...
        {txtAlert !== "" ? (
          <Alert variant="danger">{txtAlert}</Alert>
        ) : (
          ""
        )}
                      ...
                      <Select
                        ...
                        onChange={(v) => {
                          ...
                          if (
                            ...
                            setTxtAlert("Template par défaut")
                            setTestAffiche(false);
                          }
                        }}
                        options={optionFour}
...
export default ReleveMedicalGroExcel;
