...
import { allReleveMedical, allReleveMedicalBi } from "../../Redux/releveMedicalReduce";
...
function ListeReleveMedical() {
  document.title = "Liste des reléves medical grossistes";
...
export default ListeReleveMedical;
