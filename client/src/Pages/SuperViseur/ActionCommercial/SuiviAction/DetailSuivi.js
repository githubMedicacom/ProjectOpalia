...
function DetailSuivi() {
  ...
  var month_d = localStorage.getItem("month_d") ? localStorage.getItem("month_d") : 0;
  var month_f = localStorage.getItem("month_f") ? localStorage.getItem("month_f") : 0;
  var year_d = localStorage.getItem("year_d") ? localStorage.getItem("year_d") : 0;
  var year_f = localStorage.getItem("year_f") ? localStorage.getItem("year_f") : 0;
  const [entities, setEntities] = React.useState([]);
  const getPackProduit = useCallback(async () => {
    var client = null;
    if (splitPath[1] === "detailSuivi")
    ...
    else client = await dispatch(getBlByCmd(idCmd));
