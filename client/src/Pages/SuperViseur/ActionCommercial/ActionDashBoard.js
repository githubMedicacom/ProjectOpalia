...
function PackDashBoard() {
  ...
  const getCmdByAction = useCallback(async (id,objectif, arrayOption, limit) => {
    ...
    var arrayOption1 = await res.payload.arrayOption;
    ...
    setRealiser(arrayOption1);
    setDataRealiser(objBar);
  }, [date,dispatch,idRole,idUser]);
  ...
  useEffect(() => {
    ...
    getDelegue();
  }, [getActionsByYear, date,getDelegue]);
